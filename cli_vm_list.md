...
| VM PowerState 	| 状態 	| Azure ポータルでの表記 	| 備考 	|
|-----------------	|--------------------------	|-------------------------	|------------------------------------------------	|
| VM starting 	| 起動中 	| 開始中 	| － 	|
| VM running 	| 起動済み 	| 実行中 	| － 	|
| VM stopping 	| 停止中（リソース保持） 	| 実行中 	| OSのみ停止中 	|
| VM stopped 	| 停止済み（リソース保持） 	| 停止済み 	| OSのみ停止済み：コンピューティングの課金継続 	|
| VM deallocating 	| 停止中（割り当て解除） 	| 実行中or割り当て解除中 	| － 	|
| VM deallocated 	| 停止済み（割り当て解除） 	| 停止済み (割り当て解除) 	| コンピューティングの課金停止 	|
